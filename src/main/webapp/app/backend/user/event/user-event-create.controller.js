(function () {
    ...
    angular
        .module('preventApp')
        .controller('UserEventCreateController', UserEventCreateController);

    UserEventCreateController.$inject = [
        '$scope',
        '$state',
        'entity',
        'ManageLocations',
        ...
        function create() {
            if (vm.events.id == null) {
                swal({
                    ...
                    UserEvent.createEvent(vm.events)
                        .then(function (response) {
                            $state.go('event-user', null, {reload: true});
                            swal(
                                'Created',
                                'Event sukses dibust',
                                'success'
                ...
                swal({
                    ...
                    UserEvent.updateEvent(vm.events)
                        .then(function (response) {
                            $state.go('event-user', null, {reload: true});
                            swal(
                                'Update',
