...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "prevent@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "prevent API";

        private String description = "prevent API documentation";
