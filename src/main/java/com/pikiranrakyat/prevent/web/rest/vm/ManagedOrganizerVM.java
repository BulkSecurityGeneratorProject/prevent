...
import com.pikiranrakyat.prevent.service.dto.OrganizerDTO;
 ...
 */
public class ManagedOrganizerVM extends OrganizerDTO {
    ...
    public ManagedOrganizerVM() {
    }

    public ManagedOrganizerVM(Organizer o) {
        super(o);
        this.id = o.getId();
