...
import com.pikiranrakyat.prevent.service.dto.OrderMerchandiseDTO;
 ...
 */
public class ManagedOrderMerchandiseVM extends OrderMerchandiseDTO {
    ...
    public ManagedOrderMerchandiseVM() {
    }

    public ManagedOrderMerchandiseVM(OrderMerchandise o) {
        super(o);
        this.id = o.getId();
