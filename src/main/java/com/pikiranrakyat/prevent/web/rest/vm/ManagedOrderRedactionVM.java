...
import com.pikiranrakyat.prevent.service.dto.OrderRedactionDTO;
 ...
 */
public class ManagedOrderRedactionVM extends OrderRedactionDTO {
    ...
    public ManagedOrderRedactionVM() {
    }

    public ManagedOrderRedactionVM(OrderRedaction o) {
        super(o);
        this.id = o.getId();
